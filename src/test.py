...
# https://github.com/tensorflow/models/blob/master/object_detection/g3doc/detection_model_zoo.md) for a list of other
...
PATH_TO_LABELS = os.path.join('C:/Users/AltijdMelvin/Anaconda3/envs/tensorflow/Lib/site-packages/tensorflow/research'
