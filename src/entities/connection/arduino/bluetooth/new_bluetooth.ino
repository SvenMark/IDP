...
Nextion myNextion(Serial2, 9600); //create a Nextion object named myNextion using the nextion serial port @ 9600bps
...
void loop()
{
    ...
    if ((digitalRead (button1) == true) && (button_1_activated ==0)){
      ...
      value_V = 1023 - analogRead(A8);
    
      
      value_H = 1023 - analogRead(A9);

     
      value_X = 1023 - analogRead(A0);

      
      value_Y = 1023 - analogRead(A1);
