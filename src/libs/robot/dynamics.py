    ...
    for p in range(0, np):
        ...
        for j in range(0, n):
            ...
            if link.sigma == 0:
                ...
                w = Rt * w
                wd = Rt * wd
                vd = Rt * (z0 * qdd[j, 0] + vd) + crossp(wd, pstar) + 2 * crossp(w, Rt * z0 * qd[j, 0]) + crossp(w,
                                                                                                                 crossp(
                                                                                                                     w,
                                                                                                                     pstar))
            ...
            if debug:
                print
                print
                "w:\t%f\t%f\t%f" % (w[0, 0], w[1, 0], w[2, 0])
                print
                "wd:\t%f\t%f\t%f" % (wd[0, 0], wd[1, 0], wd[2, 0])
                print
                "vd:\t%f\t%f\t%f" % (vd[0, 0], vd[1, 0], vd[2, 0])
                print
                "vdbar:\t%f\t%f\t%f" % (vhat[0, 0], vhat[1, 0], vhat[2, 0])
                print
        ...
        for j in range(n - 1, -1, -1):
            ...
            if debug:
                print
                print
                "f:\t%f\t%f\t%f" % (f[0, 0], f[1, 0], f[2, 0])
                print
                "nn:\t%f\t%f\t%f" % (nn[0, 0], nn[1, 0], nn[2, 0])
                print
    ...
    for p in range(0, np):
        ...
        for j in range(0, n):
            ...
            if link.sigma == 0:
                ...
                vd_ = R * (crossp(wd, P) + crossp(w, crossp(w, P)) + vd) + 2 * crossp(R * w, z0 * qd[j, 0]) + z0 * qdd[
                    j, 0]
            ...
            if debug:
                ...
                "vd:\t%f\t%f\t%f" % (vd[0, 0], vd[1, 0], vd[2, 0])
                print
                "vdbar:\t%f\t%f\t%f" % (vdC[0, 0], vdC[1, 0], vdC[2, 0])
                print
